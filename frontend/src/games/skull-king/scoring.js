 ...
 *   bonusMalusPoints         – bonus/malus cumules (-10, -5, +5, +10)
 */
export function calculateRoundScore(data, roundNumber) {
  ...
  const bonusMalusScore = (bonusMalusPoints || 0) + (lootPoints || 0);
  ...
  return {
    ...
    bonusScore,
    bonusMalusScore,
    totalRoundScore: baseScore + bonusScore + bonusMalusScore,
  };
}
